...
export function ProjectCard({ project }: ProjectCardProps) {
  ...
  const isChallenger = project.id === 'challenger-sale';
      ...
      {isChallenger ? (
        <div className={styles.challengerPerspective}>
          ...
          >
            ...
            <div className={styles.challengerFaceBack}>
              <div className={styles.challengerBackBar}>
                <span className={styles.challengerBackLabel}>Demo</span>
                <button
                  type="button"
                  className={styles.challengerFlipBackBtn}
              ...
              <iframe
                ...
                className={styles.challengerBackIframe}
                loading="lazy"
